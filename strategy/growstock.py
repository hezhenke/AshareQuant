...
def run_strategy():
    ...
    df_strong = df2[(df2['1quarter']>30)|(df2['2quarter']>30)|(df2['3quarter']>30)]
    df_strong = df_strong.sort_values(by=['industry', '1quarter'], ascending=[True, False])
    return df_strong
if __name__ == '__main__':
    df = run_strategy()
    file_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),'data','result','result.csv')
